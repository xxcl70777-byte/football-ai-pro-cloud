...
# 1. 每日自动推荐数据源（包含“胜其他”或“负其他”的极端高赔强推项）
...
def get_daily_recommendations():
    return [
        ...
        },
        {
            ...
            "半全场": "负胜 / 胜胜",
            "总进球": "7球及以上 (超大球)",
            "has_other_alert": True, # 触发胜/负其他强推
        ...
        "details": [
            {
                ...
                "复盘归因": "主队完全掌控中场节奏，如期打出高效传控，全维度预测完美命中。"
            },
            {
                "场次": "周六 002",
                "对阵": "皇家马德里 vs 巴塞罗那",
            ...
            },
            {
                ...
                "复盘归因": "双方奉献史诗级对攻大战，全场狂轰7球，强力推介的【胜其他】高赔大获全胜！"
            }
        ]
    }
...
with tab1:
    ...
    for row in recommendations:
        # 如果包含胜/负其他高赔强推，我们在折叠标题上直接加上醒目标记
